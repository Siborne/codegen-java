...
public class BuildPo {
    ...
    public static void execute(TableInfo tableInfo) {
        ...
        try {
            ...
            //构建PO类头部信息（Package/import)
            buildPoheader(tableInfo, bw);

            //构建PO类内容
            buildPoBody(tableInfo, bw);
    ...
    private static void buildPoBody(TableInfo tableInfo, BufferedWriter bw) throws IOException {
        //构建类注释
        ...
        //构建getter/setter方法
        buildGetterAndSetter(tableInfo, bw);

        //重写toString方法
        buildToString(tableInfo, bw);
        bw.newLine();
        bw.newLine();
    ...
    private static void buildGetterAndSetter(TableInfo tableInfo, BufferedWriter bw) throws IOException {
        for (FieldInfo field : tableInfo.getFieldList()) {
    ...
    private static void buildToString(TableInfo tableInfo, BufferedWriter bw) throws IOException {
    ...
    private static void buildPoheader(TableInfo tableInfo, BufferedWriter bw) throws IOException {
