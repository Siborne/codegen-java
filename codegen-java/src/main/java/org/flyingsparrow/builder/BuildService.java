...
/*            if (tableInfo.isHaveDate() || tableInfo.isHaveDateTime()) {
            ...
            bw.write("\tList<" + tableInfo.getBeanName() + "> findListByParam(" + tableInfo.getBeanQueryName() + " " +
                    "query);");
            bw.newLine();
            bw.newLine();
            ...
            bw.write("\tLong findCountByParam(" + tableInfo.getBeanQueryName() + " query);");
            bw.newLine();
            bw.newLine();

            BuildComment.createMethodComment(bw, "分页查询");
            bw.write("\tPaginationResultVO<" + tableInfo.getBeanName() + "> findListByPage(" + tableInfo.getBeanQueryName() +
                    " query);");
            bw.newLine();
            bw.newLine();
